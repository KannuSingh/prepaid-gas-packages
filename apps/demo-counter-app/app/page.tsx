  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4 relative">
        ...
        <p className="text-xl text-muted-foreground">Smart Accounts + Prepaid Gas Paymaster Credits</p>
      </div>
        ...
        {!paymasterConfigured ? (
          ...
          <Alert variant="destructive" className="max-w-md">
            ...
            <AlertDescription className="flex items-center justify-between w-full">
              <div>
                <div className="font-medium">Paymaster Configuration Required</div>
                <div className="text-sm">Configure your paymaster to begin using the app</div>
              </div>
              <PaymasterSettings>
                <button className="text-sm underline hover:no-underline">Configure Now</button>
              </PaymasterSettings>
            </AlertDescription>
          </Alert>
        ) : !smartAccountClient ? (
              ...
              <div className="flex items-center justify-between w-full">
                <div>
                  ...
                  <div className="text-sm text-yellow-600 dark:text-yellow-300">
                    Pool #{paymasterConfig?.paymasterAddress} • Creating smart account client...
                  </div>
                </div>
              </div>
            </AlertDescription>
              ...
              <div className="flex items-center justify-between w-full">
                <div>
                  ...
                  <div className="text-sm text-green-600 dark:text-green-300">
                    Pool #{paymasterConfig?.paymasterAddress} • Smart Account Active
                  </div>
                </div>
                <PaymasterSettings>
                  <button className="text-sm underline hover:no-underline text-green-600">Edit</button>
                </PaymasterSettings>
              </div>
            </AlertDescription>
          </Alert>
