...
export class ContractError extends PrepaidGasError {
  ...
  static fromPaymasterError(
    ...
    return new ContractError(
      message,
      `PAYMASTER_${paymasterError.toUpperCase()}`,
      contractAddress,
      context
    );
  }
  ...
  constructor(
    ...
    super({
      ...
      recoveryActions: [
        ...
        'Ensure proper signing credentials',
      ],
      retryable: false,
    });
  }
...
export class UserOperationError extends PrepaidGasError {
  constructor(
    ...
    super({
      ...
      recoveryActions: [
        'Review user operation parameters',
  ...
  constructor(
    ...
    super({
      ...
      recoveryActions: [
        ...
        'Ensure sufficient pool deposits',
      ],
      retryable: false,
    });
  }
...
export class ErrorUtils {
   ...
   */
  static isErrorType<T extends PrepaidGasError>(
    error: any, 
...
export {
  PrepaidGasError,
  ValidationError as PrepaidGasValidationError,
  NetworkError,
  ContractError,
  EncodingError,
  AuthenticationError,
